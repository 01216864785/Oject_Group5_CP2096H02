...
public class Retunr extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (trangThai.equals("0")) {
            ...
            String emailNhan = vpc_OrderInfo.substring(vpc_OrderInfo.indexOf("/")+1);
            ...
            RequestDispatcher requestDispatcher = request.getRequestDispatcher("musics/Payment_results_ returned.jsp");
