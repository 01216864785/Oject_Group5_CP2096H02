...
<div class="main-header">
    ...
    <div class="main-title">List of songs</div>
</div>
<div class="main-content">
    <div class="row">
        <div class="col-3 col-sm-4">
            <a href="${pageContext.request.contextPath}/admin-songs?do=statistic" class="btn btn-default light-text"><i class='bx bx-stats'></i> Report</a>
        </div>
          <div class="col-3 col-sm-4">
                        ...
                        <tbody>
                            <c:forEach var="item" items="${list}">
                                <tr id="row${item.songID}">
                                    ...
                                    <td>${controller.formatDate(item.release)}</td>
