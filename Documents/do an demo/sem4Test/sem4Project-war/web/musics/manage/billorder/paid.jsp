    ...
    <tbody id="myTable2">
        ...
        <tr>
            ...
            <td style="border:0px">
                ...
                <%} else { %>
                <img height="20px" src="https://img.icons8.com/cotton/64/000000/delete-sign--v2.png" title="Order unpaid"/> <%if(BankName.equals("Admin"))out.print("<samp style='color: red'> Admin</samp>"); %>
                <%}
                    }%>
            </td> 
            <td style="border:0px"><% out.print(DateOrder); %></td>
