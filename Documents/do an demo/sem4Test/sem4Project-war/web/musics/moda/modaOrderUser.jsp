        ...
        <div style="color:black">
            <div class="w3-container">
                ...
                <div>
                    ...
                    <label>
                        Amount to deposit : 
                        <input type="text" id="mony"  placeholder="Enter the amount to deposit" class="w3-input w3-border w3-round-larg">$
                    </label>
                    </p>
                </div>
            </div>
        ...
        <div class="w3-container">
            <div> 
                ...
                <div style="color: black">
                    ...
                    <input class="w3-input w3-border w3-round-xxlarge" name="last" type="text"  id="pass" placeholder="Enter PassWord">
